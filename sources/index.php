...
$news = $cache->get("select name$lang, slug$lang, desc$lang, date_created, id, photo from #_news where type = ? and find_in_set('hienthi',status) ORDER BY numb, id desc", array('tin-tuc'), 'result', 7200);
