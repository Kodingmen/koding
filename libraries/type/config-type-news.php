...
/* Course (List) */
$config['news'][$nametype]['title_main_list'] = "Khóa học cấp 1";
...
$config['news'][$nametype]['width_list'] = 360;
$config['news'][$nametype]['height_list'] = 235;
$config['news'][$nametype]['thumb_list'] = '100x100x1';
$config['news'][$nametype]['img_type_list'] = '.jpg|.gif|.png|.jpeg|.gif';


$nametype = "su-nghiep";
$config['news'][$nametype]['title_main'] = "Sự Nghiệp";
$config['news'][$nametype]['check'] = array("hienthi" => "Hiển thị", "noibat" => "Nổi bật");
$config['news'][$nametype]['dropdown'] = true;
$config['news'][$nametype]['list'] = true;
$config['news'][$nametype]['check_all'] = false;
...
$config['news'][$nametype]['content_cke'] = true;
$config['news'][$nametype]['seo'] = true;
$config['news'][$nametype]['width'] = 370;
...
/* Courses */
$nametype = "kinh-nghiem";
$config['news'][$nametype]['title_main'] = "Kinh Nghiệm";
$config['news'][$nametype]['check'] = array("hienthi" => "Hiển thị", "noibat" => "Nổi bật");
$config['news'][$nametype]['dropdown'] = true;
$config['news'][$nametype]['list'] = true;
$config['news'][$nametype]['check_all'] = false;
...
$config['news'][$nametype]['img_type_list'] = '.jpg|.gif|.png|.jpeg|.gif';
/* Courses */
$nametype = "kenh-ban-hang";
$config['news'][$nametype]['title_main'] = "Kênh Bán Hàng";
$config['news'][$nametype]['check'] = array("hienthi" => "Hiển thị", "noibat" => "Nổi bật");
$config['news'][$nametype]['dropdown'] = true;
$config['news'][$nametype]['list'] = true;
$config['news'][$nametype]['check_all'] = false;
