...
<head>
    ...
    <!-- Favicon -->
    <link href="assets/images/favicon-cong-ty-tltvietnam.png" rel="shortcut icon" type="image/x-icon" />

    <!-- Css all -->
    <?php include TEMPLATE . LAYOUT . "css.php"; ?>
</head>

<body class="<?= (!isset($_SESSION[$loginAdmin]['active']) || $_SESSION[$loginAdmin]['active'] == false) ? 'login-page' : 'sidebar-mini hold-transition text-sm' ?>">
    <!-- Loader -->
