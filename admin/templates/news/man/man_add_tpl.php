        ...
        <div class="row">
            ...
            <div class="<?= $colRight ?>">
                ...
                <?php if(isset($config['news'][$type]['video']) && $config['news'][$type]['video']== true) { ?>
                    <div class="form-group">
                        <label for="link_video">Video <?=$config['news'][$type]['title_main']?>:</label>
            ...
            <div class="card-body">
                ...
                <?php if(isset($config['news'][$type]['email']) && $config['news'][$type]['email'] == true) { ?>
                    <div class="form-group col-md-4 col-sm-6">
                        ...
                        <input type="text" class="form-control" name="data[options][email]" id="email" placeholder="Email" value="<?=$options['email']?>">
                    </div>
                <?php } ?>
                ...
                <?php if(isset($config['news'][$type]['facebook']) && $config['news'][$type]['facebook'] == true) { ?>
                    <div class="form-group col-md-4 col-sm-6">
                        ...
                        <input type="text" class="form-control" name="data[options][facebook]" id="facebook" placeholder="Facebook" value="<?=$options['facebook']?>">
                    </div>
                <?php } ?>
                ...
                <?php if(isset($config['news'][$type]['chucvu']) && $config['news'][$type]['chucvu'] == true) { ?>
                    <div class="form-group col-md-4 col-sm-6">
                        ...
                        <input type="text" class="form-control" name="data[options][chucvu]" id="chucvu" placeholder="Chức vụ" value="<?=$options['chucvu']?>">
                    </div>
                <?php } ?>
                <?php if(isset($config['news'][$type]['bando']) && $config['news'][$type]['bando'] == true) { ?>
                    <div class="form-group col-md-4 col-sm-6">
                        <label for="bando">Bản đồ:</label>                        
                        <textarea class="form-control for-seo" name="data[options][bando]" id="bando" rows="5" placeholder="Bản đồ"><?=htmlspecialchars_decode(@$options['bando'])?></textarea>
                    </div>
                <?php } ?>
                <?php if(isset($config['news'][$type]['diachi']) && $config['news'][$type]['diachi'] == true) { ?>
                    <div class="form-group col-md-4 col-sm-6">
                        <label for="diachi">Địa chỉ:</label>                        
                        <textarea class="form-control for-seo" name="data[options][diachi]" id="diachi" rows="5" placeholder="Địa chỉ"><?=htmlspecialchars_decode(@$options['diachi'])?></textarea>
                    </div>
                <?php } ?>
            </div>
            <div class="card-body">
