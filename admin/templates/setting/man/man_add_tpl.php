        ...
        <div class="card card-primary card-outline text-sm">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <?php } ?>
                    <?php if (isset($config['setting']['address2']) && $config['setting']['address2'] == true) { ?>
                        <div class="form-group col-md-4 col-sm-6">
                            <label for="address">Địa chỉ 2:</label>
                            <input type="text" class="form-control text-sm" name="data[options][address2]" id="address2" placeholder="Địa chỉ 2" value="<?= (!empty($flash->has('address2'))) ? $flash->get('address2') : @$options['address2'] ?>">
                        </div>
                    <?php } ?>
